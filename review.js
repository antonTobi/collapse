...
// recorded game line.
(function () {
    const REVIEW_WEIGHTS = 'bot/weights/anneal14-manual-rect6-6M-Rcq.bin'
    ...
    const GRAPH_SPEC = 'fx:weights=' + REVIEW_WEIGHTS + ',depth=2,cap=16,topk=2,rootk=6,crn=1,freeze=1,esc=6,sampling=pair'
